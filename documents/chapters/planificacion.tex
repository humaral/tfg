...
\section{Estimación de costes}
    ...
    \subsection{Coste en un entorno profesional}
        ...
        Dado que el desarrollo se ha planificado siguiendo un modelo en cascada, donde cada fase se ejecuta de forma secuencial, se asume que todas las tareas podrían ser realizadas por un único profesional. 
