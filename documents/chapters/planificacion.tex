...
\section{Análisis de riesgos}
    En esta sección se muestran los principales riesgos identificados durante la planificación del proyecto, junto con su probabilidad de ocurrencia, su impacto y las posibles medidas para mitigarlos, Tabla \ref{tab:3.2}. 
...
\section{Seguimiento del proyecto}
    ...
    En cuanto al coste real del proyecto, el gasto ascendería a 5648€, superando el presupuesto inicial en 848€. 
