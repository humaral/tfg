...
\subsection{Pruebas del bot de Discord}
    ...
    \begin{table}[H]
        ...
        \textbf{Descripción} & El usuario finaliza un trámite o cancela o cuelga la llamada. \\ \hline
        \textbf{Resultado esperado} & El bot detecta la acción del usuario, libera los recursos y finaliza la llamada. \\ \hline
        \textbf{Resultado obtenido} &  \\ \hline
        \end{tabular}
