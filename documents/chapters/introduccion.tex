...
\section{Resumen del resto de la memoria}
    ...
    \begin{description}
        ...
        \item[Capítulo 4 Diseño] Se detallan la arquitectura general y los distintos componentes del sistema. 
        Aismismo, se presentan los diagramas y patrones de diseño eligidos, que servirán de base para la implementación.

        \item[Capítulo 5 Implementación] Se describe el proceso de desarrollo del sistema, detallando la implementación de cada uno de los módulos.

        \item[Capítulo 6 Pruebas] Se exponen las distintas pruebas realizadas parar verificar el correcto funcionamiento de cada uno de los componentas del sistema.
    \end{description}