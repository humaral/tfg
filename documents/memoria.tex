...
\chapter{Análisis}
    ...
    \section{Requisitos}
        ...
        \begin{enumerate}
            ...
            \item[RF5.] El sistema deberá permitir identificarse a los empleados con su usuario y contraseña en la plataforma web administrativa.
    ...
    \section{Casos de uso}
        ...
        \subsection{Solicitud la tarjeta sanitaria de SACYL por pérdida o robo:}
            Actor principal: usuario.
        ...
        \label{subsec:2.4.6.}
            ...
            Precondición: caso de uso \hyperref[subsec:2.4.5.]{2.4.5. Inicia sesión}.
        ...
        \subsection{Petición revisable:}
            ...
            Precondición: caso de uso \hyperref[subsec:2.4.6.]{2.4.6. Consultar detalles de una petición}.
    ...
    \section{Modelo de dominio:}
        \begin{figure}[H]
            \centering
            \includegraphics[width=1\textwidth]{diagramas/modelo_domino.png}
