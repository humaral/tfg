...
insert into ESTADOPETICION values(1,'En Curso', 'mdi:progress-clock');
insert into ESTADOPETICION values(2,'Revisable', 'ic:twotone-error');
insert into ESTADOPETICION values(3,'Asignada', 'mdi:user-edit');
insert into ESTADOPETICION values(4,'Completada', 'charm:circle-check');
insert into ESTADOPETICION values(5,'Cancelada', 'charm:circle-cross');
