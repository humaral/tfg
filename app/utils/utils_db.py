...
def poblar_peticiones():
    ...
    crear_peticion("722643980", 2, {"dni" : "75849123L", "nombre" : "Juan González Aparicio", "servicio" : "Renta", "modalidad" : "presencial", "oficina" : "Delegación Especial de Castilla y León", "dia" : str(date(2026, 2, 12)), "hora" : "10:30"}),
    crear_peticion("834521234", 2, {"dni" : "12507943Z", "nombre" : "Sara Alonso García", "servicio" : "Registro en Cl@ve", "modalidad" : "telefonica", "email" : "saraaa@gmail.com"}),
    ...
    for i in range(26):   
        ...
        opciones = [
            ...
            lambda: crear_peticion(str(tel), 2, {"dni" : "75849123L", "nombre" : "Juan González Aparicio", "servicio" : "Renta", "modalidad" : "presencial", "oficina" : "Delegación Especial de Castilla y León", "dia" : str(date(2026, 2, 12)), "hora" : "10:30"}),
            lambda: crear_peticion(str(tel), 2, {"dni" : "12507943Z", "nombre" : "Sara Alonso García", "servicio" : "Registro en Cl@ve", "modalidad" : "telefonica", "email" : "saraaa@gmail.com"}),
